...
def main() -> int:
    ...
    valid_predictions = prediction_frame(valid_frame, fused_scores_array=valid_scores, threshold=config.threshold)
    test_predictions = prediction_frame(test_frame, fused_scores_array=test_scores, threshold=config.threshold)
