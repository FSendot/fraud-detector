#!/usr/bin/env python3
"""Train a direct Nyström-kernel baseline on prepared tabular features."""
...
from training.train_utils import (  # noqa: E402
    ...
    default_tabular_nystrom_paths,
    default_tabular_nystrom_prediction_paths,
    ensure_parent,
    load_model_input,
    set_global_seed,
    split_model_input,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train a direct Nyström classifier on tabular model input.",
    )
...
def main() -> int:
    ...
    default_train, default_valid, default_test, default_model, default_metrics = default_tabular_nystrom_paths()
    default_valid_pred, default_test_pred = default_tabular_nystrom_prediction_paths()
    ...
    write_json(
        ...
        {
            "branch_name": "direct_tabular_nystrom_gp",
            "config": config.to_payload(),
            "valid": valid_metrics,
            "test": test_metrics,
            "tabular_feature_count": train_features.shape[1],
